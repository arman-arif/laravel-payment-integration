                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            @forelse($payments as $payment)
                                <tr>
                                    ...
                                    <td class="px-5 py-4 sm:px-6">
                                        <div class="flex items-center">
                                            <p class="text-gray-500 text-sm dark:text-gray-400">${{ number_format($payment->amount, 2) }}</p>
                                        </div>
                                    </td>
                                    <td class="px-5 py-4 sm:px-6">
                                        <div class="flex items-center">
                                ...
                                <tr>
                                    <td colspan="7" class="px-5 py-8 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-sm text-gray-400 dark:text-gray-500">Get started by creating your first payment</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                    ...
                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Are you sure you want to delete this payment? This action cannot be undone and will permanently remove the payment record from the system.
                            </p>
                        </div>
                    </div>
                </div>
