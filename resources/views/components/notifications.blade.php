<div class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
    ...
    <div x-show="dropdownOpen"
        class="shadow-theme-lg dark:bg-gray-dark absolute -right-[240px] mt-[17px] flex max-h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:right-0 dark:border-gray-800">
        ...
        <ul class="custom-scrollbar flex flex-col overflow-y-auto h-[21.5rem]:">
            <li>
                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                    ...
                    <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                        <img src="{{ asset('assets/avatar-default.svg') }}" alt="User" class="overflow-hidden rounded-full size-10" />
                        <span
